...
public class BasePedestalVariants {
	...
	public static List<PedestalVariant> VARIANTS = List.of(
		...
		new PedestalVariant("polished_tuff_pedestal", "polished_tuff", () -> Blocks.POLISHED_TUFF),
		...
		new PedestalVariant("quartz_pedestal", "quartz", () -> Blocks.QUARTZ_BLOCK),
		...
		// terracotta glazed
		new PedestalVariant("black_terracotta_glazed_pedestal", "black_terracotta_glaze", () -> Blocks.BLACK_GLAZED_TERRACOTTA),
		new PedestalVariant("blue_terracotta_glazed_pedestal", "blue_terracotta_glaze", () -> Blocks.BLUE_GLAZED_TERRACOTTA),
		new PedestalVariant("brown_terracotta_glazed_pedestal", "brown_terracotta_glaze", () -> Blocks.BROWN_GLAZED_TERRACOTTA),
		new PedestalVariant("green_terracotta_glazed_pedestal", "green_terracotta_glaze", () -> Blocks.GREEN_GLAZED_TERRACOTTA),
		new PedestalVariant("gray_terracotta_glazed_pedestal", "gray_terracotta_glaze", () -> Blocks.GRAY_GLAZED_TERRACOTTA),
		new PedestalVariant("orange_terracotta_glazed_pedestal", "orange_terracotta_glaze", () -> Blocks.ORANGE_GLAZED_TERRACOTTA),
		new PedestalVariant("purple_terracotta_glazed_pedestal", "purple_terracotta_glaze", () -> Blocks.PURPLE_GLAZED_TERRACOTTA),
		new PedestalVariant("light_gray_terracotta_glazed_pedestal", "light_gray_terracotta_glaze", () -> Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA),
		new PedestalVariant("light_blue_terracotta_glazed_pedestal", "light_blue_terracotta_glaze", () -> Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA),
		new PedestalVariant("pink_terracotta_glazed_pedestal", "pink_terracotta_glaze", () -> Blocks.PINK_GLAZED_TERRACOTTA),
		new PedestalVariant("red_terracotta_glazed_pedestal", "red_terracotta_glaze", () -> Blocks.RED_GLAZED_TERRACOTTA),
		new PedestalVariant("white_terracotta_glazed_pedestal", "white_terracotta_glaze", () -> Blocks.WHITE_GLAZED_TERRACOTTA),
		new PedestalVariant("yellow_terracotta_glazed_pedestal", "yellow_terracotta_glaze", () -> Blocks.YELLOW_GLAZED_TERRACOTTA),
		new PedestalVariant("magenta_terracotta_glazed_pedestal", "magenta_terracotta_glaze", () -> Blocks.MAGENTA_GLAZED_TERRACOTTA),
		new PedestalVariant("cyan_terracotta_glazed_pedestal", "cyan_terracotta_glaze", () -> Blocks.CYAN_GLAZED_TERRACOTTA),
		new PedestalVariant("lime_terracotta_glazed_pedestal", "lime_terracotta_glaze", () -> Blocks.LIME_GLAZED_TERRACOTTA),
