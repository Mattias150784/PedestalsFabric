...
public class SmoothStonePedestalBlockEntityRenderer implements BlockEntityRenderer<SmoothStonePedestalBlockEntity> {
    ...
    public SmoothStonePedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(SmoothStonePedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
