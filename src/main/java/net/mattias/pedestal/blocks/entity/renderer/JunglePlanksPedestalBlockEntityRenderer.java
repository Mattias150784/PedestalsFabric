...
public class JunglePlanksPedestalBlockEntityRenderer implements BlockEntityRenderer<JunglePlanksPedestalBlockEntity> {
    ...
    public JunglePlanksPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(JunglePlanksPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
