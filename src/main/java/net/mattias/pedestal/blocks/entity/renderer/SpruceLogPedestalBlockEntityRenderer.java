...
public class SpruceLogPedestalBlockEntityRenderer implements BlockEntityRenderer<SpruceLogPedestalBlockEntity> {
    ...
    public SpruceLogPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(SpruceLogPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
