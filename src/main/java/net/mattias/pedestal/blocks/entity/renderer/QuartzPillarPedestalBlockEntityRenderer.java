...
public class QuartzPillarPedestalBlockEntityRenderer implements BlockEntityRenderer<QuartzPillarPedestalBlockEntity> {
    ...
    public QuartzPillarPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(QuartzPillarPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
