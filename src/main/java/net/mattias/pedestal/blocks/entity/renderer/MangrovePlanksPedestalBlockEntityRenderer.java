...
public class MangrovePlanksPedestalBlockEntityRenderer implements BlockEntityRenderer<MangrovePlanksPedestalBlockEntity> {
    ...
    public MangrovePlanksPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(MangrovePlanksPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
