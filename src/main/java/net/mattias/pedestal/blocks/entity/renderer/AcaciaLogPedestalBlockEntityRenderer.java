...
public class AcaciaLogPedestalBlockEntityRenderer implements BlockEntityRenderer<AcaciaLogPedestalBlockEntity> {
    ...
    public AcaciaLogPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(AcaciaLogPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
