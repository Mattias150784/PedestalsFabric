...
public class BambooPlanksPedestalBlockEntityRenderer implements BlockEntityRenderer<BambooPlanksPedestalBlockEntity> {
    ...
    public BambooPlanksPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(BambooPlanksPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
