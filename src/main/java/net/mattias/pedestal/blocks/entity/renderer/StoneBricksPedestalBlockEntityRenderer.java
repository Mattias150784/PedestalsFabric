...
public class StoneBricksPedestalBlockEntityRenderer implements BlockEntityRenderer<StoneBricksPedestalBlockEntity> {
    ...
    public StoneBricksPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(StoneBricksPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
