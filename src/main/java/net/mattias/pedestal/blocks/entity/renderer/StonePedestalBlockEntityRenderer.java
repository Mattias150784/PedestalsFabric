...
public class StonePedestalBlockEntityRenderer implements BlockEntityRenderer<StonePedestalBlockEntity> {
    ...
    public StonePedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(StonePedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
