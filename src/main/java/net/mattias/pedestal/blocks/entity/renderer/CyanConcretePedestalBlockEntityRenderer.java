...
public class CyanConcretePedestalBlockEntityRenderer implements BlockEntityRenderer<CyanConcretePedestalBlockEntity> {
    ...
    public CyanConcretePedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(CyanConcretePedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
