...
public class SoulSoilPedestalBlockEntityRenderer implements BlockEntityRenderer<SoulSoilPedestalBlockEntity> {
    ...
    public SoulSoilPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(SoulSoilPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
