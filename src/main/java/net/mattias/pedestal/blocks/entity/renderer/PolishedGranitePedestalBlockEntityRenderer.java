...
public class PolishedGranitePedestalBlockEntityRenderer implements BlockEntityRenderer<PolishedGranitePedestalBlockEntity> {
    ...
    public PolishedGranitePedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(PolishedGranitePedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
