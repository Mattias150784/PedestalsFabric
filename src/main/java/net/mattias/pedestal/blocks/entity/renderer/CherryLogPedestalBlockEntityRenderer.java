...
public class CherryLogPedestalBlockEntityRenderer implements BlockEntityRenderer<CherryLogPedestalBlockEntity> {
    ...
    public CherryLogPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(CherryLogPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
