...
public class PurpurBlockPedestalBlockEntityRenderer implements BlockEntityRenderer<PurpurBlockPedestalBlockEntity> {
    ...
    public PurpurBlockPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(PurpurBlockPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
