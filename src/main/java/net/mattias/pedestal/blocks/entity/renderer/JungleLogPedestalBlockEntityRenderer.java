...
public class JungleLogPedestalBlockEntityRenderer implements BlockEntityRenderer<JungleLogPedestalBlockEntity> {
    ...
    public JungleLogPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(JungleLogPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
