...
public class PolishedTuffPedestalBlockEntityRenderer implements BlockEntityRenderer<PolishedTuffPedestalBlockEntity> {
    ...
    public PolishedTuffPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(PolishedTuffPedestalBlockEntity entity, float tickDelta, MatrixStack matrices,
